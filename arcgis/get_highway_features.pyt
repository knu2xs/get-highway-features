...
if importlib.util.find_spec("get_highway_features") is None:
    src_dir = find_pkg_source("get_highway_features")
...
class Toolbox:
    def __init__(self):
        ...
        self.label = "get-highway-features"
        self.alias = "get_highway_features"
...
class CreateDataDirectory:
    ...
    def execute(self, parameters, messages):
        ...
        get_highway_features.utils.configure_logging("INFO")
        ...
        get_highway_features.utils.build_data_resources(dir_data)
