...
logger = get_logger(logger_name="get_highway_features", level="INFO")
...
def example_function(in_path: Union[str, Path]) -> pd.DataFrame:
    ...
    ``` python
    from get_highway_features import example_function
...
class ExampleObject(object):
    ...
    def example_static_function(in_path: Union[str, Path]) -> pd.DataFrame:
        ...
        ``` python
        from get_highway_features import ExampleObject
    ...
    def example_class_method(cls) -> "ExampleObject":
        ...
        ``` python
        from from get_highway_features import ExampleObject
